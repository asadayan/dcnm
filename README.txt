...
Example: python dcnm_add_bulk_vrf.py IBM_VxLAN_Fabric ibmvRF 70001 20 0 1 0
This will create 20 vrfs, with each vrf starting prefix being ibmvRF on DCNM fabric IBM_VxLAN_Fabric with host_route being enabled for each vrf.

output:
python dcnm_add_bulk_vrf.py IBM_VxLAN_Fabric ibmvRF 70001 20 0 1 0
...
python dcnm_delete_vrf.py IBM_VxLAN_Fabric all
...
python dcnm_delete_networks.py IBM_VxLAN_Fabric all
...
python dcnm_attach_intf.py IBM_VxLAN_Fabric e1/41-43 ibm all
...
python dcnm_detach_intf.py IBM_VxLAN_Fabric ibm
...
python dcnm_detach_vpc.py IBM_VxLAN_Fabric ibm

and

python dcnm_detach_bulk_po.py
usage python dcnm_detach_bulk_po.py fabric-name [net-prefix]
python dcnm_detach_bulk_po.py IBM_VxLAN_Fabric ibm
...
python dcnm_delete_po.py IBM_VxLAN_Fabric
...
python dcnm_delete_vpc.py IBM_VxLAN_Fabric
