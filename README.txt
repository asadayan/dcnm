DCNM rest api based python scripts are created mainly for DCNM based POC setup.
...
Step-2: Edit dcnm_credentials.py to update the dcnm ip address and it credentials

Given below are some examples.

======
python dcnm_add_bulk_vrf.py
usage python dcnm_add_bulk_vrf.py fabric-name vrf_prefix start_l3vni number_of_vrf [DefaultRouteFlag] [HostRouteFlag] [StaticDefaultRouteFlag]
Example: python dcnm_add_bulk_vrf.py DEMO_VxLAN_Fabric DEMOvRF 70001 20 0 1 0
This will create 20 vrfs, with each vrf starting prefix being DEMOvRF on DCNM fabric DEMO_VxLAN_Fabric with host_route being enabled for each vrf.

output:
python dcnm_add_bulk_vrf.py DEMO_VxLAN_Fabric DEMOvRF 70001 20 0 1 0
Fabric Name: DEMO_VxLAN_Fabric VRF Name: DEMOvRF-001  L3 VNI: 70001  status: created
                            ---- OUTPUT TRUNCATED-----
Fabric Name: DEMO_VxLAN_Fabric VRF Name: DEMOvRF-020  L3 VNI: 70020  status: created
...
DCNM takes time in saving and deploying, it is better NOT to save and deploy for each configuration run.

======

To delete all undeployed bulk vrf:

python dcnm_delete_vrf.py DEMO_VxLAN_Fabric all

Do you really want to delete all the un deployed vrfs in the fabric DEMO_VxLAN_Fabric? if yes confirm by typing "yes":yes
Deleting all the un deployed vrfs in the fabric DEMO_VxLAN_Fabric
 vrf DEMOvRF-001 deleted
 vrf DEMOvRF-002 deleted
 vrf DEMOvRF-003 deleted

=======================

python dcnm_add_bulk_network.py
Enter the fabric Name: DEMO_VxLAN_Fabric
...
Network DEMOvRF-001_NET_13007 created under vrf DEMOvRF-001
                           ---- OUTPUT TRUNCATED-----
Network DEMOvRF-020_NET_13046 created under vrf DEMOvRF-020
...
python dcnm_delete_networks.py DEMO_VxLAN_Fabric all
Do you really want to delete all the un deployed Networks in the fabric DEMO_VxLAN_Fabric? if yes confirm by typing "yes":yes
Deleting all the un deployed Networks in the fabric DEMO_VxLAN_Fabric
Number of Deployed Networks: 30

Network DEMOvRF-001_NET_13001 deleted
   ---- OUTPUT TRUNCATED-----
Network DEMOvRF-020_NET_13040 deleted
Do you want to save and deploy?[Y/N]n
Save separately ..
...
Enter the first 3 characters of the network created to configure only those network: DEMO
...
'OK\n'
Starting vpc deployment in the fabric DEMO_VxLAN_Fabric
...
{'DEMOvRF-001_NET_19001-[FDO242109B1/Leaf-1]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
...
{'DEMOvRF-020_NET_19040-[FDO23480XXX/Leaf-3]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS',
 'DEMOvRF-020_NET_19040-[FDO242109B1/Leaf-1]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
...
Enter the first 3 characters of the networks created(net prefix): DEMO
['e1/31,e1/32', 'e1/33,e1/34']
Please enter the vrf name for the routed port channel: default if there is no vrf:DEMOvRF-001
...
port_channel port_channel601 added with e1/31,e1/32 on DEMO_POAP_SW
'OK\n'
port_channel port_channel602 added with e1/33,e1/34 on DEMO_POAP_SW
'OK\n'
  ---- OUTPUT TRUNCATED-----
...
port_channel port_channel650 added with e1/35,e1/36 on DEMO_POAP_SW
'OK\n'
port_channel port_channel651 added with e1/37,e1/38 on DEMO_POAP_SW
'OK\n'
 ---- OUTPUT TRUNCATED-----
port_channel port_channel664 added with e1/39,e1/40 on Leaf-4
'OK\n'
Starting port_channel deployment in the fabric DEMO_VxLAN_Fabric
Network information fetched
returning all network list
Attaching port_channel port-channels to networks..
{'DEMOvRF-001_NET_19001-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS'}
Interface Port-channel650,Port-channel651,Port-channel652 with VLAN 701 attached to DEMO_POAP_SW
{'DEMOvRF-001_NET_19001-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS',
 'DEMOvRF-001_NET_19001-[FDO242109B1/Leaf-1]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
Interface Port-channel653,Port-channel654,Port-channel655 with VLAN 701 attached to Leaf-1
 ...
 {'DEMOvRF-020_NET_19040-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS',
 'DEMOvRF-020_NET_19040-[FDO234602KX/Leaf-2]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS',
 'DEMOvRF-020_NET_19040-[FDO23480XXX/Leaf-3]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS',
 'DEMOvRF-020_NET_19040-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS',
 'DEMOvRF-020_NET_19040-[FDO242109B1/Leaf-1]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
...
only on those network starting with 'DEMO'

python dcnm_attach_intf.py DEMO_VxLAN_Fabric e1/41-43 DEMO all
...
---------OUTPUT TRUNCATED------------
attached interfaces to node DEMO_POAP_SW,172.28.81.209
{'DEMOvRF-001_NET_19001-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS',
 'DEMOvRF-001_NET_19002-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS',
 'DEMOvRF-002_NET_19003-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS',
 ---------OUTPUT TRUNCATED------------
 'DEMOvRF-019_NET_19037-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS',
 'DEMOvRF-019_NET_19038-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS',
 'DEMOvRF-020_NET_19039-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS',
 'DEMOvRF-020_NET_19040-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
Do you want to save and deploy?[Y/N]n
...
python dcnm_detach_intf.py DEMO_VxLAN_Fabric DEMO

Network information fetched
returning all network list
Network name prefix not matching skipping network Network_30031
detached interfaces to node DEMO_POAP_SW,172.28.81.209
{}
-------- OUTPUT TRUNCATED ---------
Network name prefix not matching skipping network Network_30019
detached interfaces to node DEMO_POAP_SW,172.28.81.209
{}
Network prefix matched, going to detach interface from network DEMOvRF-001_NET_19001
detached interfaces to node DEMO_POAP_SW,172.28.81.209
{'DEMOvRF-001_NET_19001-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS'}
Network prefix matched, going to detach interface from network DEMOvRF-001_NET_19002
detached interfaces to node DEMO_POAP_SW,172.28.81.209
{'DEMOvRF-001_NET_19002-[FDO23440CZ6/DEMO_POAP_SW]': 'SUCCESS'}
Network prefix matched, going to detach interface from network DEMOvRF-002_NET_19003
-------- OUTPUT TRUNCATED ---------

Network prefix matched, going to detach interface from network DEMOvRF-019_NET_19038
detached interfaces to node Leaf-4,172.28.81.238
{'DEMOvRF-019_NET_19038-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
Network prefix matched, going to detach interface from network DEMOvRF-020_NET_19039
detached interfaces to node Leaf-4,172.28.81.238
{'DEMOvRF-020_NET_19039-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
Network prefix matched, going to detach interface from network DEMOvRF-020_NET_19040
detached interfaces to node Leaf-4,172.28.81.238
{'DEMOvRF-020_NET_19040-[FDO23480Y42/Leaf-4]': 'SUCCESS Peer attach Reponse :  '
                                              'SUCCESS'}
Saved Config
...
python dcnm_detach_vpc.py DEMO_VxLAN_Fabric DEMO

and

python dcnm_detach_bulk_po.py
usage python dcnm_detach_bulk_po.py fabric-name [net-prefix]
python dcnm_detach_bulk_po.py DEMO_VxLAN_Fabric DEMO
...
python dcnm_delete_po.py DEMO_VxLAN_Fabric
...
python dcnm_delete_vpc.py DEMO_VxLAN_Fabric
