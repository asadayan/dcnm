...
if len(sys.argv) < 7:
    ...
    print("Example: python dcnm_add_network.py POC-FABRIC VRF-RED 300001 1001 12.1.1.1/24 2001:1/64 224.1.1.2 1")
...
segurl = url + f'/rest/managed-pool/fabrics/{fabricName}/segments/ids'
segpayload = {
            "segmentId": networkId
            }
...
mulurl = url + f'/rest/managed-pool/fabrics/{fabricName}/multicast-group-address?segment-id={networkId}'
mulpayload = {
