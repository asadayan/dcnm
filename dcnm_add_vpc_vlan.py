...
my_parser = argparse.ArgumentParser(prog='dcnm_add_vpc',
...
intf_range = dcnm_modules.get_intf_set(args.intf) # Convert the given interface range and discrete interface to elements of interface
...
dcnm_modules.attach_vpc_interface(fabricName,network_list_prefix,vpc_list)
